...
from nltk import pos_tag, sent_tokenize, PorterStemmer, word_tokenize
...
# with open("/server/model/RandomForest2.pkl", 'rb') as f:
...
pickle_path = os.path.join(current_dir, "model", "RandomForest2.pkl")

# Use the pickle_path variable when opening the file
with open(pickle_path, 'rb') as f:
    news_pipeline = pickle.load(f)
...
class PredictionModel:
    ...
    def predict(self):
        ...
        self.output['prediction'] = 'FAKE' if news_pipeline.predict(
